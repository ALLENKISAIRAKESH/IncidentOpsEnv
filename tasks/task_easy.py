...
def _generate_noise_logs(service: str, count: int = 5) -> list[LogEntry]:
    import random
    messages = [
...
NOISE_LOGS: dict = {
    "auth-service": _generate_noise_logs("auth-service"),
    "fraud-detector": _generate_noise_logs("fraud_detector"),
}
