...
# --- Gradio UI Layout ---
with gr.Blocks(title="IncidentOpsEnv Dashboard") as dashboard:
    gr.HTML("<h1 style='text-align: center;'>[ALERT] IncidentOpsEnv - Interactive SRE Dashboard</h1>")
    ...
    with gr.Row():
        with gr.Column(scale=1):
            ...
            init_btn = gr.Button("Initialize Simulator [START]", variant="primary")
        ...
        with gr.Column(scale=2):
            dashboard_display = gr.Markdown("### [STATUS] Dashboard Offline. Please Initialize.")
