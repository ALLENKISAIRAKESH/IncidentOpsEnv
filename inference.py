...
def run_episode(task: str):
    ...
    # Success criteria logic - determined by final resolution validation state.
    success_str = "true" if obs.is_resolved else "false"
    rewards_joined = ",".join(rewards_history)
    print(f"[END] success={success_str} steps={step} rewards={rewards_joined}")


if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument("--task", default="all", help="Task ID or 'all' to run all tasks")
